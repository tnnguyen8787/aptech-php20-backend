...
<p>Exercise 1 - Checking $a = 9 is smaller or larger $b = 15</p>
<?php
$a = 9;
$b = 15;
if ($a < $b) {
    ...
    echo "15 is larger than 9";
}
?>

<p>Display the meaning of acronym of some programming languages, using switch</p>
<?php
$language = "JS";
switch ($language) {
    case "JS";
